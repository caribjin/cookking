...
_.extend(App.helpers, {
	...
	getPicture: function(type, callback) {
		...
		MeteorCamera.getPicture({
			...
			width: Meteor.settings.public.defaultCameraImageWidth,
			height: Meteor.settings.public.defaultCameraImageHeight,
			quality: Meteor.settings.public.defaultCameraImageQuality,
...
Meteor.startup(function() {
	...
	if (moment) {
		moment.locale(Meteor.settings.public.locale);
	}
	...
	$(document.body).touchwipe({
		...
		min_move_x: Meteor.settings.public.menuOpenWipeDistance,
