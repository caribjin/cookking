...
Template.RecipeWrite.setTab = function(tab) {
	...
	$('.basic-info-scrollable').velocity({translateZ: 0, translateX: matrix[tab][0]}, {duration: Meteor.settings.public.defaultAnimationDuration, easing: 'ease-out'});
	$('.ingredients-scrollable').velocity({translateZ: 0, translateX: matrix[tab][1]}, {duration: Meteor.settings.public.defaultAnimationDuration, easing: 'ease-out', visibility: 'visible'});
	$('.directions-scrollable').velocity({translateZ: 0, translateX: matrix[tab][2]}, {duration: Meteor.settings.public.defaultAnimationDuration, easing: 'ease-out', visibility: 'visible'});
};
...
Template.RecipeWrite.ingredientAdd = function(type, text) {
	var limitCount = Meteor.settings.public.ingredientsCountLimit || 20;
